...
class Patternlibrary_DocRenderer {
    ...
    renderPatternDocumentation ( ) {
        var $this = this,
            tmplPath = this._projectPath('gui/src/pages/template-supercollider.html')
        ;
    ...
    renderCategoryIndexPage( category ) {
        ...
        for (var i in indexPages) {
            ...
            var layout   = this._getLayoutFromFile( this._projectPath('gui/src/layouts/patternpage.html') );

...
module.exports = function(file, opts, cb) {
    ...
    if (!page.example)   { page.example   = page.source; } // path.join(  relativePatternPath, './index.html'); }
    if (!page.specs)     { page.specs     = page.source; } // path.join(  relativePatternPath, './index.html'); }

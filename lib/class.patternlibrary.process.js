...
module.exports = function() {
  return through.obj(patternlibrary_process_gulp_file_stream.bind(this));
}
 ...
 * @param function cb
 */
function patternlibrary_process_gulp_file_stream ( file, enc, cb ) {
    ...
    try {
	    ...
	    if (!file.stat.isDirectory()) {
		    ...
		    extend(patternData, {
		        ...
		        root: this._processRoot(file.path, this.Panini.options.root)
		    });

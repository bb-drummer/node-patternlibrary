...
class Patternlibrary {
	...
	/**
	 * register Panini/Handlebars helpers
	 */
	_registerPatternHelpers ( ) {
		//this._loadLayouts(['layouts','node_modules/patternlibrary/layouts']);
		//this._loadLayouts('../layouts');
		//this._loadLayouts(process.cwd()+'/layouts');
		this.Panini.loadLayouts(['layouts','node_modules/patternlibrary/layouts']);
		this.Panini.loadHelpers(['helpers','node_modules/patternlibrary/helpers']);
	}
	
	_loadLayouts (dir) {
		
		  var layouts = this._readdir(dir, '**/*.{html,hbs,handlebars}');

		  for (var i in layouts) {
		    var ext = path.extname(layouts[i]);
		    var name = path.basename(layouts[i], ext);
		    var file = fs.readFileSync(layouts[i]);
		    this.Panini.layouts[name] = this.Handlebars.compile(file.toString());
		  }
		}
 ...
 */
Patternlibrary.prototype.processFileStream = require('./class.patternlibrary.process.js');

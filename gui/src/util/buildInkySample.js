...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link rel="stylesheet" href="../assets/css/plfoundation-emails.css">
  </head>
  <body>
    <table class="body">
      <tr>
 ...
 * @returns {string} HTML for the Inky and HTML examples. The function also writes an HTML file to disk containing the live HTML example, with the PLFoundation for Emails CSS referenced.
 */

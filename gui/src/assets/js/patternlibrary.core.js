...
"use strict";
    ...
    var patternlibrary = {
        ...
        registerPlugin: function(plugin, name){
            ...
            if(!plugin.$element.data('patternlibraryPlugin')){ plugin.$element.data('patternlibraryPlugin', plugin); }
                        /**
                ...
                $elem.each(function() {
                    ...
                    if ($el.data('patternlibraryPlugin')) {
                        console.warn("Tried to initialize "+name+" on an element that "+
                                "already has a [patternlibrary] plugin: ", $el);
                        return;
                    }
    ...
    var siteapp = function(method) {
        ...
        $('body').addClass(
            (typeof PLFoundation == 'undefined') ? 'bootstrap' : 'plfoundation'
        );

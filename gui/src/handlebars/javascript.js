 ...
 * ```js
 * var elem = new Siteapp.Plugin(element, options);
 * ```
 *
...
handlebars.registerHelper('writeJsConstructor', function(name) {
  var str = 'var elem = new Siteapp.'+name+'(element, options);';
 ...
 * ```js
 * $('#element').siteapp('method', param1, param2);
 * ```
 *
...
handlebars.registerHelper('writeJsFunction', function(method) {
  var str = '$(\'#element\').siteapp(\'' + method.name;
